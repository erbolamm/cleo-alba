...
class _WelcomeScreenState extends State<WelcomeScreen> {
  ...
  final String _websiteUrl = 'https://apliarte.com';
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Column(
          ...
          children: [
            ...
            SizedBox(height: 5),
            Text('1. Cierre la app y vuelva a abrirla en 5 minutos.',
                style: TextStyle(color: Colors.white70)),
            Text('2. Verifique que Termux esté ejecutando el servicio.',
                style: TextStyle(color: Colors.white70)),
            Text('3. Si el error persiste, REINICIE EL TELÉFONO.',
                style: TextStyle(
        ...
        actions: [
          TextButton(
            ...
            child: const Text('MODO RESCATE (HTML)',
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        foregroundColor:
                            _serverOnline ? Colors.black : Colors.white24,
                        padding: const EdgeInsets.symmetric(
                          horizontal: 20,
                          vertical: 18,
                        ),
